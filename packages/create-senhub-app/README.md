...
create-senhub-app/3.2.26 darwin-x64 node-v18.3.0
...
_See code: [dist/commands/init.ts](https://github.com/tuphan-dn/sen-core/blob/v3.2.26/dist/commands/init.ts)_
...
_See code: [dist/commands/manifest.ts](https://github.com/tuphan-dn/sen-core/blob/v3.2.26/dist/commands/manifest.ts)_
...
FLAGS
  -d, --directory=<value>  [default:
                           /Users/tuphan/Desktop/sen-core/packages/create-senhub-app/create-senhub-app.manifest.json]
                           The directory to the manifest file. Default option will automatically search the manifest
...
_See code: [dist/commands/publish.ts](https://github.com/tuphan-dn/sen-core/blob/v3.2.26/dist/commands/publish.ts)_
<!-- commandsstop -->
