...
create-senhub-app/3.0.49 darwin-x64 node-v18.3.0
...
_See code: [dist/commands/init.ts](https://github.com/tuphan-dn/sen-core/blob/v3.0.49/dist/commands/init.ts)_
...
_See code: [dist/commands/manifest.ts](https://github.com/tuphan-dn/sen-core/blob/v3.0.49/dist/commands/manifest.ts)_
